<template>
  <div class="min-h-screen pt-28 pb-20 relative overflow-hidden bg-surface">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
      ...
      <div class="glass-card p-4 rounded-3xl mb-12 border border-border shadow-xl flex flex-col md:flex-row gap-4 items-center justify-between animate-reveal" style="animation-delay: 100ms">
        <!-- Search input -->
